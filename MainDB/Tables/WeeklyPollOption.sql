...
(
    ...
    [CreatedOn] DATETIME NOT NULL CONSTRAINT [DF_WeeklyPollOption_CreatedOn] DEFAULT GETDATE(), 
    [ModifiedOn] DATETIME NOT NULL CONSTRAINT [DF_WeeklyPollOption_ModifiedOn] DEFAULT GETDATE(),
