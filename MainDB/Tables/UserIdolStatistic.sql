...
(
    ...
    [CreatedOn] DATETIME NOT NULL CONSTRAINT [DF_UseIdolStatistic_CreatedOn] DEFAULT GETDATE(),
    [ModifiedOn] DATETIME NOT NULL CONSTRAINT [DF_UseIdolStatistic_ModifiedOn] DEFAULT GETDATE(), 
