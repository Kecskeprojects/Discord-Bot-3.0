...
(
    ...
    [CreatedOn] DATETIME NOT NULL CONSTRAINT [DF_Server_CreatedOn] DEFAULT GETUTCDATE(), 
    [ModifiedOn] DATETIME NOT NULL CONSTRAINT [DF_Server_ModifiedOn] DEFAULT GETUTCDATE(), 
    [MuteRoleId] INT NULL, 
