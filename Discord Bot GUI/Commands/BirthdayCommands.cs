...
{
    public class BirthdayCommands(IBirthdayService birthdayService, IServerService serverService, Logging logger, Config config) : BaseCommand(logger, config, serverService)
    {
