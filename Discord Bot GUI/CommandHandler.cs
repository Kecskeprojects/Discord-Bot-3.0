...
//https://embed.dan.onl/
//https://message.style/
//EmbedGroup Table: EmbedGroupId, ServerId, ChannelId, MessageId
//Embed Table: EmbedId, EmbedGroupId, ContentType (int)(Image, Embed), ImageUrl (Nullable), EmbedContent (Nullable)(json mssql format?)
